...
parser.add_argument('--ep', default=150, type = int, help = 'epoch')
parser.add_argument('--caseid', default=1, type = int, help = 'caseid')
...
ep = args.ep
caseid = args.caseid
print(model1, model2, n, m, l1, l2, r1, r2, res_d, ep, t)


# In[19]:


directory="./results-BENN-sensitivity-1/result-" + str(model1) + "-" + str(model2) + "-" + str(caseid) + "-" + str(n)
...
y_suff_test_df.to_csv("./results-BENN-sensitivity-1/result-" + str(model1) + "-" + str(model2) + "-" + str(caseid) + "-" + str(n) + "/y_suff_" + str(t) + ".csv")
...
time_use_df.to_csv("./results-BENN-sensitivity-1/result-" + str(model1) + "-" + str(model2) + "-" + str(caseid) + "-" + str(n) + "/time_" + str(t) + ".csv")
