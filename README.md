...
### Some required files for other methods

- GMDDNet: `NSDR.py` `plotutils.py` (from https://github.com/booml247/StoNet_SDR_NeurIPS)
- StoNet: `model.py` `train_stonet.py` `tools.py` (from the codes of Chen et al. (2024). https://doi.org/10.1214/24-AOS2390)
...
- Models A--C: `data-generation-nonlinear-0.R` (preliminary: `data-generation-nonlinear-0-prelim.R`)
