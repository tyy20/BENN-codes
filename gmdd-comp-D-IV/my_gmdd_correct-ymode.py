...
parser.add_argument('--y_mode', default=2, type = int, help = 'y_mode')
...
directory="./results-GMDD-correct/result-" + str(model1) + "-" + str(model2) + "-" + str(n) + "-" + str(y_mode)
...
model = NSDR(neural_network=net_seq, max_dim=res_d, method = "seq", adaptive_cv=False, 
             ...
             categorical_y = False, iter_num=iter_num, y_mode=y_mode)
...
y_suff_test_df.to_csv("./results-GMDD-correct/result-" + str(model1) + "-" + str(model2)  + "-" + str(n) + "-" + str(y_mode) + "/y_suff_" + str(t) + ".csv")
...
time_use_df.to_csv("./results-GMDD-correct/result-" + str(model1) + "-" + str(model2) + "-" + str(n) + "-" + str(y_mode) + "/time_" + str(t) + ".csv")
