...
for(n in 1000*(1:8)){
  ...
  results.summary=rbind(results.summary,
                        list(model1=4,model2=model2,n=n,y_mode=0,avg1=mean(res1),std1=sd(res1)))
...
results.summary.gmdd=results.summary
...
results.summary.benn=results.summary

save(results.summary.benn,results.summary.gmdd,
     file=paste("./results-model4-4-gmdd-ymode.Rdata",sep=""))




load("./results-model4-4-gmdd-ymode.Rdata")
results.summary.ymode=results.summary.gmdd

results.gmdd.model4=results.summary.ymode[results.summary.ymode$y_mode==0,]
...
results.benn3.model4=results.summary.benn
